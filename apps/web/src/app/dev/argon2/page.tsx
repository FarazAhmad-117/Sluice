 ...
 * evidence. It is also the only thing in the app that imports the worker, which
 * is what makes `next build` actually compile and emit it -- a worker nothing
 * references is a worker whose bundling has never been proven.
 *
...
export default function Argon2DiagnosticsPage() {
